...
${OBJECTDIR}/_ext/e82ab63d/AppNodeStar.o: /home/sysadmin/projects/nodestar/AppNodeStar.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/e82ab63d
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e82ab63d/AppNodeStar.o /home/sysadmin/projects/nodestar/AppNodeStar.cpp

${OBJECTDIR}/_ext/e82ab63d/Server.o: /home/sysadmin/projects/nodestar/Server.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/e82ab63d
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e82ab63d/Server.o /home/sysadmin/projects/nodestar/Server.cpp

${OBJECTDIR}/_ext/e82ab63d/WCAdmin.o: /home/sysadmin/projects/nodestar/WCAdmin.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/e82ab63d
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e82ab63d/WCAdmin.o /home/sysadmin/projects/nodestar/WCAdmin.cpp

${OBJECTDIR}/_ext/400e14d7/DbRecUser.o: /home/sysadmin/projects/nodestar/model/DbRecUser.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/400e14d7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/400e14d7/DbRecUser.o /home/sysadmin/projects/nodestar/model/DbRecUser.cpp

${OBJECTDIR}/_ext/400e14d7/UserAuth.o: /home/sysadmin/projects/nodestar/model/UserAuth.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/400e14d7
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/400e14d7/UserAuth.o /home/sysadmin/projects/nodestar/model/UserAuth.cpp
